...
export function EditStudentForm({ student, onSave, trigger }: EditStudentFormProps) {
  ...
  <DialogContent className="sm:max-w-[600px] max-h-[90vh] bg-white pt-2 p-0 sm:p-6 w-screen h-screen max-w-full max-h-screen fixed top-0 left-0 rounded-none z-50 flex flex-col overflow-hidden">
