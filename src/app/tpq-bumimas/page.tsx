...
export default function TpqBumimas() {
  // Get TPQ colors
  ...
  // Filter students untuk Bumimas & level terpilih
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="mt-8 border-0 shadow-lg">
        <CardHeader>
          <CardTitle className="text-blue-800 font-bold">Informasi TPQ Bumimas</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="space-y-2 text-blue-900 text-base">
            <p><span className="font-semibold">Alamat:</span> Bumimas, Desa Jati</p>
      ...
      <Card className="mt-4 border-0 shadow-lg">
        <CardHeader>
          <CardTitle className="text-blue-800 font-bold">Daftar Generus {selectedLevel} - TPQ Bumimas</CardTitle>
        </CardHeader>
        <CardContent>
